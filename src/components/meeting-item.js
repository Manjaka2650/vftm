...
export function MeetingItem({ meeting, view = "grid", fetchdata }) {
  ...
  const truncatedContent = truncateHTMLWithTags(meeting.content, 100);
    ...
    >
      ...
      <div className="flex flex-col flex-grow">
        ...
        <CardFooter className="p-4 pt-0 mt-auto">
          <Link
            href={`/admin/reunion/update/${meeting.id_reunion}`}
            passHref
            className="w-full"
          >
